...
# printDictionary(documentFreq, 5)
...
fpkl = '/Users/abiga/Desktop/AbiiSnn/GitHub/Natural-Language-Processing/Practice/9/vectors.pkl'
# makePKL(fpkl, vectors)
...
word = ('economía', 'n')
l = []
l = getSyntagmatic(vectors, vocabulary, word)
# print(l[:30])

nWord = "economia_n.txt"
nameFile = '/Users/abiga/Desktop/AbiiSnn/GitHub/Natural-Language-Processing/Practice/9/'
