...
def getFrecuency(vocabulary, contexts, b, k, documentFreq):
	vectors = {}
	for term in vocabulary:
...
nameFile = '/Users/27AGO2019/Desktop/AbiiSnn/GitHub/Natural-Language-Processing/Normalize/similitudBM25RetrievalModel.txt'
language = 'spanish'
code = 'utf-8'
...
k = 1.2
vectors = {}
vectors = getFrecuency(vocabulary, contexts, b, k, documentFreq)
